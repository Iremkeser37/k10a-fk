...
CREATE TABLE IF NOT EXISTS `kitap` (
  ...
  PRIMARY KEY (`sira`),
  KEY `FK_kitap_yazar` (`yazar sira`),
  KEY `FK_kitap_tur` (`tur sira`),
  CONSTRAINT `FK_kitap_tur` FOREIGN KEY (`tur sira`) REFERENCES `tur` (`sira`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_kitap_yazar` FOREIGN KEY (`yazar sira`) REFERENCES `yazar` (`sira`) ON DELETE NO ACTION ON UPDATE NO ACTION
